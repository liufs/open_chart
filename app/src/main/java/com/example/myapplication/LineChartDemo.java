...
public class LineChartDemo extends AppCompatActivity implements View.OnClickListener {
  ...
  void initLine() {
    ...
    createLine(mList2, mEntries2, mLineDataSet2, Color.YELLOW, mLineData, mLineChart);
    createLine(mList3, mEntries3, mLineDataSet3, Color.GREEN, mLineData, mLineChart);
...
//    lineChart.invalidate();
   ...
   * @param yValues y值
   */
  public void addEntry(LineData lineData, LineChart lineChart, float yValues,
                       int index) {
  ...
  public void addLine1Data(float yValues) {
    for(int i= 0 ;i < 100; i++){
      ...
      addEntry(mLineData, mLineChart, getRandom(30f), LINE_NUMBER_1);
    }
